        ...
        <div className="">
          <main className="relative  mt-10">
                ...
                <div className="md:text-right text-center flex flex-col justify-between mt-8 md:-mt-6 md:w-1/2 py-4">
                  ...
                  <div className="pt-8">
                    <span className="inline-flex rounded-full shadow">
                      <a
                        href="#"
                        className="inline-flex items-center px-4 py-1 border border-transparent text-base font-medium rounded-full text-white bg-blue-400 hover:bg-gray-50 tracking-wider"
                      >
                        Buy Now
                      </a>
                    </span>
            ...
            <div className="text-center mx-auto max-w-5xl px-4">
              <div className="text-center h-screen flex items-center justify-center">
                <div>
                  <div className="mb-40 max-w-screen">
                  ...
                  <p className="font-mono mt-3 max-w-md mx-auto text-base sm:text-md md:mt-5">
                    The OintTag works with any URL. Simply enter it in during
                    the one step setup.
                  </p>{" "}
                  <span className="inline-flex rounded-full shadow mt-6">
                    <a
                      href="#"
                      className="inline-flex items-center px-4 py-1 border border-transparent text-base font-medium rounded-full text-indigo-600 bg-white hover:bg-gray-50"
                    >
